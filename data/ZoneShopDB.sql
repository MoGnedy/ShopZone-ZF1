...
--
-- Host: localhost
-- Generation Time: Mar 16, 2017 at 09:10 AM
...
-- Database: `ZoneShopDB`
--
CREATE DATABASE IF NOT EXISTS `ZoneShopDB` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `ZoneShopDB`;
...
-- Procedures
--
DROP PROCEDURE IF EXISTS `check_off`$$
